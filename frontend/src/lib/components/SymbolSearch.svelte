<script lang="ts">
	...
	const POPULAR = [
		...
		{ label: '/SI', group: 'Futures' },
		{ label: '/ZB', group: 'Futures' },
		{ label: '/ZN', group: 'Futures' },
		{ label: '/ZC', group: 'Futures' },
		{ label: '/ZW', group: 'Futures' },
		{ label: '/ZS', group: 'Futures' },
		{ label: '/NG', group: 'Futures' },
		{ label: '/RTY', group: 'Futures' },
		{ label: '/YM', group: 'Futures' },
